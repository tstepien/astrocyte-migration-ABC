...
InputOpts.Marginals(7).Parameters = [bestfitdist_param{7}.mu bestfitdist_param{7}.sigma];  % (/hr)
InputOpts.Marginals(7).Bounds = [0 0.1];  % (/hr)

InputOpts.Marginals(8).Name = '$\beta_2$';  % differentiation rate wrt choroid oxygen
