...
mu = 4.9; %%% adhesion constant
alpha10 = 1.2; %%% (/hr) basal proliferation rate APC
alpha11 = 1.1; %%% (/hr) proliferation rate APC wrt PDGFA
alpha12 = 0.5; %%% (/hr) proliferation rate APC wrt choroid oxygen
alpha13 = 0.94; %%% (/hr) proliferation rate APC wrt hylaoid oxygen
alpha20 = 1; %%% (/hr) basal proliferation rate IPA
alpha21 = 0.48; %%% (/hr) proliferation rate IPA wrt PDGFA
alpha22 = 1; %%% (/hr) proliferation rate IPA wrt choroid oxygen
alpha23 = 1.1; %%% (/hr) proliferation rate IPA wrt hyaloid oxygen
beta0 = 0.94; %%% (/hr) basal differentiation rate
beta1 = 1.1; %%% (/hr) differentiation rate wrt LIF
beta2 = 0; %%% (/hr) differentiation rate wrt choroid oxygen
beta3 = 0; %%% (/hr) differentiation rate wrt hyaloid oxygen
beta4 = 0.94; %%% (/hr) mass action rate
eta1 = 0.73; %%% (/hr) apoptosis rate APC
eta2 = 1.1; %%% (/hr) apoptosis rate IPA

%%%%%%%%%%%%%%%%%%%%%%%%%%%%% hyaloid artery %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
P_hy = 10; %%% partial pressure of oxygen due to hyaloid artery
r_hy = 0.99; %%% radius at half-maximum of Hill function for hyaloid
