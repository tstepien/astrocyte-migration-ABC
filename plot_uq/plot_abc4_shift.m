...
load(strcat('../parameter_analysis/abc',num2str(num_param),'_',...
    num2str(multiplier),'e',num2str(power),'_shift.mat'))
...
% set alpha12 = 0.125
% set mu=0.033
param_original = [alpha11, alpha21, beta1, beta4];

clear err_dens err_rad err_time err_tot mu alpha11 alpha21 beta1 beta4;

param_names = {'$\alpha_{11}$','$\alpha_{21}$','$\beta_1$','$\beta_4$'};
num_param = length(param_names);
param_names_words = {'APC prolif wrt PDGFA',...
