...
param_original = [mu, alpha10, alpha11, alpha20, alpha21, ...
    alpha22, alpha23, beta1, beta4, eta1 , eta2 , P_hy , r_hy];

clear err_dens err_rad err_time err_tot mu alpha11 ...
    alpha21 alpha22 alpha23 beta1 beta4 eta1 eta2 Te P_hy r_hy;

param_names = {'$\mu$','$\alpha_{10}$','$\alpha_{11}$',...
    '$\alpha_{20}$','$\alpha_{21}$','$\alpha_{22}$','$\alpha_{23}$','$\beta_1$',...
...
param_names_words = {'Adhesion constant','APC base prolif rate',...
    'APC prolif wrt PDGFA','IPA base prolif rate',...
    'IPA prolif wrt PDGFA','APC prolif wrt choroid O_2',...
    'IPA prolif wrt hyaloid O_2','Diff rate wrt LIF','Mass action rate',...
