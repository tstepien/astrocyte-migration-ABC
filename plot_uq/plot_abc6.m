...
% remove beta2
param_original = [mu, alpha11, alpha12, alpha21, beta1, beta4];
...
param_names_words = {'Adhesion constant','APC prolif wrt PDGFA',...
    'APC prolif wrt choroid O_2','IPA prolif wrt PDGFA',...
    'Diff rate wrt LIF','Mass action rate'};
