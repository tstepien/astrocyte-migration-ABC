...
% remove alpha13, alpha20, alpha23, beta3, Phy, rhy
% remove beta0, eta1
% remove eta2
% remove alpha10, alpha22
% remove beta2
% set alpha12 = 0.125
param_original = [mu, alpha11, alpha21, beta1, beta4];

clear err_dens err_rad err_time err_tot mu alpha11 alpha21 beta1 beta4;

param_names = {'$\mu$','$\alpha_{11}$','$\alpha_{21}$','$\beta_1$','$\beta_4$'};
num_param = length(param_names);
param_names_words = {'Adhesion constant','APC prolif wrt PDGFA',...
    'IPA prolif wrt PDGFA','Diff rate wrt LIF','Mass action rate'};
