...
param_original = [mu, alpha10, alpha11, alpha12, alpha21, ...
    alpha22, beta0, beta1, beta2, beta4, eta1 , eta2];

clear err_dens err_rad err_time err_tot mu alpha10 alpha11 alpha12 ...
    alpha21 alpha22 beta0 beta1 beta2 beta4 eta1 eta2;

param_names = {'$\mu$','$\alpha_{10}$','$\alpha_{11}$','$\alpha_{12}$',...
    '$\alpha_{21}$','$\alpha_{22}$','$\beta_0$','$\beta_1$','$\beta_2$',...
    '$\beta_4$','$\eta_1$','$\eta_2$'};
...
param_names_words = {'Adhesion constant','APC base prolif rate',...
    ...
    'Base diff rate','Diff rate wrt LIF','Diff rate wrt choroid O_2',...
