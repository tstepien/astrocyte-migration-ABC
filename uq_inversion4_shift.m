...
PriorOpts.Marginals(1).Name = '$\alpha_{11}$';  % proliferation rate APC wrt PDGFA
PriorOpts.Marginals(1).Type = 'Uniform';
PriorOpts.Marginals(1).Parameters = [0 2];  % (/hr)
PriorOpts.Marginals(1).Bounds = [0 2];  % (/hr)

PriorOpts.Marginals(2).Name = '$\alpha_{21}$';  % proliferation rate IPA wrt PDGFA
PriorOpts.Marginals(2).Type = 'Uniform';
PriorOpts.Marginals(2).Parameters = [0 2];  % (/hr)
PriorOpts.Marginals(2).Bounds = [0 2];  % (/hr)

PriorOpts.Marginals(3).Name = '$\beta_1$';  % mass action rate
PriorOpts.Marginals(3).Type = 'Uniform';
PriorOpts.Marginals(3).Parameters = [0 2];  % (/hr)
PriorOpts.Marginals(3).Bounds = [1.5 4];  % (/hr)

PriorOpts.Marginals(4).Name = '$\beta_4$';  % differentiation rate wrt hyaloid oxygen
