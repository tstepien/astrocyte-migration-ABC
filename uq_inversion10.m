...
PriorOpts.Marginals(7).Name = '$\beta_1$';  % mass action rate
PriorOpts.Marginals(7).Type = 'Uniform';
PriorOpts.Marginals(7).Parameters = [0 2];  % (/hr)
PriorOpts.Marginals(7).Bounds = [0 2];  % (/hr)

PriorOpts.Marginals(8).Name = '$\beta_2$';  % differentiation rate wrt LIF
...
PriorOpts.Marginals(10).Name = '$\eta_2$';  % apoptosis rate IPA
