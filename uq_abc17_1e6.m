...
bound = [0.01 10; %mu - adhesion constant
...
beta3   = 0;
beta4   = (bound(13,2) - bound(13,1))*LHpts(:,13) + bound(13,1);
eta1    = (bound(14,2) - bound(14,1))*LHpts(:,14) + bound(14,1);
eta2    = (bound(15,2) - bound(15,1))*LHpts(:,15) + bound(15,1);
P_hy    = (bound(16,2) - bound(16,1))*LHpts(:,16) + bound(16,1);
r_hy    = (bound(17,2) - bound(17,1))*LHpts(:,17) + bound(17,1);
