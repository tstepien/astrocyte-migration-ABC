...
InputOpts.Marginals(3).Parameters = [bestfitdist_param{3}.mu bestfitdist_param{3}.sigma];  % (/hr)
...
InputOpts.Marginals(8).Name = '$\alpha_{23}$';  % proliferation rate IPA wrt hyaloid oxygen
...
InputOpts.Marginals(13).Name = '$P_\mathrm{hy}$';  % partial pressure of oxygen due to hyaloid artery
InputOpts.Marginals(13).Type = 'Uniform';
InputOpts.Marginals(13).Parameters = [0 20];  % (dimensionless)
InputOpts.Marginals(13).Bounds = [0 20];  % (dimensionless)

InputOpts.Marginals(14).Name = '$r_\mathrm{hy}$';  % radius at half-maximum of Hill function for hyaloid
InputOpts.Marginals(14).Type = 'Uniform';
InputOpts.Marginals(14).Parameters = [0.001 2];  % (mm)
InputOpts.Marginals(14).Bounds = [0.001 2];  % (mm)
