function k_new = cellpops_sum(j,c1_old,c2_old,q1,PO2,dt,r,Pm,kappa,mu,...
    alpha10,alpha11,alpha12,alpha13,alpha20,alpha21,alpha22,alpha23,...
    eta1,eta2,ce,cmax,hyaloid)
% k_new = cellpops_sum(j,c1_old,c2_old,q1,PO2,dt,r,Pm,kappa,mu,...
%     alpha10,alpha11,alpha12,alpha13,alpha20,alpha21,alpha22,alpha23,...
%     eta1,eta2,ce,cmax,hyaloid)
%
% inputs:
...
g = growthterms_sum(c1_old(1:j),c2_old(1:j),q1(1:j),PO2(1:j),Pm,alpha10,...
    alpha11,alpha12,alpha13,alpha20,alpha21,alpha22,alpha23,eta1,eta2,...
    cmax,hyaloid);
