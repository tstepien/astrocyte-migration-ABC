...
alpha21 = (bound(3,2) - bound(3,1))*LHpts(:,3) + bound(3,1);
beta1   = (bound(4,2) - bound(4,1))*LHpts(:,4) + bound(4,1);
beta4   = (bound(5,2) - bound(5,1))*LHpts(:,5) + bound(5,1);
