...
alpha23 = (bound(8,2) - bound(8,1))*LHpts(:,8) + bound(8,1);
beta0   = 0;
beta1   = (bound(9,2) - bound(9,1))*LHpts(:,9) + bound(9,1);
beta2   = 0;
beta3   = 0;
beta4   = (bound(10,2) - bound(10,1))*LHpts(:,10) + bound(10,1);
eta1    = (bound(11,2) - bound(11,1))*LHpts(:,11) + bound(11,1);
eta2    = (bound(12,2) - bound(12,1))*LHpts(:,12) + bound(12,1);
P_hy    = (bound(13,2) - bound(13,1))*LHpts(:,13) + bound(13,1);
r_hy    = (bound(14,2) - bound(14,1))*LHpts(:,14) + bound(14,1);
