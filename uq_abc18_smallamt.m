...
bound = [5 20; %mu - adhesion constant
    ...
    0 1; %alpha20 - (/hr) base proliferation rate IPA
    0 1; %alpha21 - (/hr) proliferation rate IPA wrt PDGFA
    0 1; %alpha22 - (/hr) proliferation rate IPA wrt choroid oxygen
...
for i=1:N
    ...
    %%% solve equation
    [t,r,c1,c2,q1,q2,mvgbdy,vel_cir,vel_rad,choroidPO2] = eqnsolver(mu(i),alpha10(i),alpha11(i),...
    ...
    disp(['total error: ',num2str(err_tot(i))])
