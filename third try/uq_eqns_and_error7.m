function Y = uq_eqns_and_error7(X)
% Y = uq_eqns_and_error7(X)
%
...
%
% inputs:
%   X = [mu, alpha11, alpha12, alpha21, beta1, beta2, beta4]
%
...
for i=1:N
    [t,r,c1,c2,~,~,mvgbdy,~,~] = eqnsolver(mu(i),alpha10,alpha11(i),...
        alpha12(i),alpha13,alpha20,alpha21(i),alpha22,alpha23,...
        beta0,beta1(i),beta2(i),beta3,beta4(i),eta1,eta2,...
        P_hy,r_hy,m);
