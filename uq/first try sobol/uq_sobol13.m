...
% InputOpts.Marginals(4).Parameters = [bestfitdist_param{4}.A bestfitdist_param{4}.B];  % (/hr)
...
InputOpts.Marginals(4).Name = '$\alpha_{20}$';  % base proliferation rate IPA
...
InputOpts.Marginals(7).Name = '$\alpha_{23}$';  % proliferation rate IPA wrt hyaloid oxygen
...
InputOpts.Marginals(12).Parameters = [0 20];  % (dimensionless)
...
InputOpts.Marginals(13).Parameters = [0.001 2];  % (mm)
InputOpts.Marginals(13).Bounds = [0.001 2];  % (mm)
