...
%     if strcmp(doublecheck,'y')==1
        diary(strcat(pwd,'/ABC_results/diary_abc',num2str(num_param),'_',...
...
beta4   = (bound(11,2) - bound(11,1))*LHpts(:,11) + bound(11,1);
beta3   = 0;
...
% if strcmp(savefiles,'yes')==1
    save(strcat(pwd,'/ABC_results/abc',num2str(num_param),'_',...
