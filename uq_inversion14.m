...
PriorOpts.Marginals(7).Parameters = [0 1];  % (/hr)
PriorOpts.Marginals(7).Bounds = [0 1];  % (/hr)

PriorOpts.Marginals(8).Name = '$\alpha_{23}$';  % proliferation rate IPA wrt hyaloid oxygen
...
PriorOpts.Marginals(9).Name = '$\beta_1$';  % mass action rate
...
PriorOpts.Marginals(10).Name = '$\beta_4$';  % differentiation rate wrt hyaloid oxygen
PriorOpts.Marginals(10).Type = 'Uniform';
PriorOpts.Marginals(10).Parameters = [0 2];  % (/hr)
PriorOpts.Marginals(10).Bounds = [0 2];  % (/hr)

PriorOpts.Marginals(11).Name = '$\eta_1$';  % apoptosis rate APC
PriorOpts.Marginals(11).Type = 'Uniform';
PriorOpts.Marginals(11).Parameters = [0 2];  % (/hr)
PriorOpts.Marginals(11).Bounds = [0 2];  % (/hr)

PriorOpts.Marginals(12).Name = '$\eta_2$';  % apoptosis rate IPA
PriorOpts.Marginals(12).Type = 'Uniform';
PriorOpts.Marginals(12).Parameters = [0 2];  % (/hr)
PriorOpts.Marginals(12).Bounds = [0 2];  % (/hr)

PriorOpts.Marginals(13).Name = '$P_\mathrm{hy}$';  % partial pressure of oxygen due to hyaloid artery
PriorOpts.Marginals(13).Type = 'Uniform';
PriorOpts.Marginals(13).Parameters = [0 20];  % (dimensionless)
PriorOpts.Marginals(13).Bounds = [0 20];  % (dimensionless)

PriorOpts.Marginals(14).Name = '$r_\mathrm{hy}$';  % radius at half-maximum of Hill function for hyaloid
PriorOpts.Marginals(14).Type = 'Uniform';
PriorOpts.Marginals(14).Parameters = [0.001 2];  % (mm)
PriorOpts.Marginals(14).Bounds = [0.001 2];  % (mm)
