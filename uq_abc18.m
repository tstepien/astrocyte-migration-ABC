...
bound = [5 20; %mu - adhesion constant
    0 0.25; %alpha10 - (/hr) base proliferation rate APC
    0 0.25; %alpha11 - (/hr) proliferation rate APC wrt PDGFA
    0 0.25; %alpha12 - (/hr) proliferation rate APC wrt choroid oxygen
    0 0.25; %alpha13 - (/hr) proliferation rate APC wrt hyaloid oxygen
    0 0.25; %alpha20 - (/hr) base proliferation rate IPA
    0 0.25; %alpha21 - (/hr) proliferation rate IPA wrt PDGFA
    0 0.25; %alpha22 - (/hr) proliferation rate IPA wrt choroid oxygen
    0 0.25; %alpha23 - (/hr) proliferation rate IPA wrt hyaloid oxygen
    ...
    0 0.25; %eta1 - (/hr) apoptosis rate APC
    0 0.25; %eta2 - (/hr) apoptosis rate IPA
...
parfor i=1:N
    ...
    par_save18(sprintf(strcat(pwd,'/ABC_results/abc18/output%d.mat'), i), ...
